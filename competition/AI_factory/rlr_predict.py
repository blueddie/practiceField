...
model.load_weights('C:\\_data\\dataset\\output\\model_unet_hoon66_line_final_weightsBASE1.h5')
...
for i in test_meta['test_img']:
    ...
    y_pred = np.where(y_pred[0, :, :, 0] > 0.30, 1, 0) # 임계값 처리
    y_pred = y_pred.astype(np.uint8)
    y_pred_dict[i] = y_pred

joblib.dump(y_pred_dict, 'C:\\_data\\dataset\\output\\y_pred_0313threshold03.pkl')