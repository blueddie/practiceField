...
model.load_weights('C:\\_data\\dataset\\output\\checkpoint-unet-hoon3_line-epoch_50.hdf5')
...
joblib.dump(y_pred_dict, 'C:\\_data\\dataset\\output\\y_pred3.pkl')