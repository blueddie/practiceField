...
# model.load_weights('C:\\_data\\dataset\\output\\checkpoint-unet-hoon4_line-epoch_95.hdf5')
...
# joblib.dump(y_pred_dict, 'C:\\_data\\dataset\\output\\y_pred4.pkl')