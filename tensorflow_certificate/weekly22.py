...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # suggestion.
        keras.layers.Conv1D(filters=32,kernel_size=2,input_shape=(10,1),padding='same',activation='sigmoid'),
        keras.layers.Conv1D(filters=64, kernel_size=2, padding='same', activation='sigmoid'),
